...
import ca.nait.dmit.domain.AlbertaCovid19DataReader;
...
public class AlbertaCovid19DataReaderService {
    ...
    private List<AlbertaCovid19DataReader> loadCsvData() throws IOException {
        try (var reader = new BufferedReader(new InputStreamReader(
                getClass().getResourceAsStream("/Data/covid-19-alberta-statistics-summary-data.csv")))) {
            final var delimiter = ",(?=(?:[^\"]*\"[^\"]*\")*[^\"]*$)";
            String line;
            // Skip the first line as it contains column heading
            reader.readLine();
            ...
            while ( (line = reader.readLine()) != null) {
                ...
                AlbertaCovid19DataReader lineData = new AlbertaCovid19DataReader();
